...
const BRAND_COLORS = [
  ...
  { name: "Acento principal", hex: "#FF6A00", role: "Acento", cmyk: "C0 M58 Y100 K0", pantone: "PMS 1655 C", usage: "Corte, CTA, linha de energia, marcação e assinatura visual." },
...
const COMPONENTS = [
  { title: "Botões", items: ["Primário", "Secundário", "Acento"], rule: "bg: #FF6A00 · color: #0B0B0B · font: Bebas Neue · radius: 2px" },
      ...
      <header className="brandbook-control-hero">
        <div>
          ...
          <div className="brandbook-chip-row">
            <Tag color="#FF6A00">20 páginas</Tag>
...
.brandbook-shell{display:grid;gap:18px;--bb-orange:#FF6A00;--bb-dark:#050505;--bb-black:#0B0B0B;--bb-cream:#F5F5F3;--bb-muted:#8e8e8e;--bb-border:rgba(255,255,255,.12)}
