...
export const EmptyState = ({ title, text, action, icon = "+" }) => (
  <div className="metric-tile" style={{ textAlign: "center", padding: 28 }}>
    <div style={{ width: 42, height: 42, borderRadius: 14, margin: "0 auto 12px", display: "grid", placeItems: "center", background: "rgba(249,115,22,.12)", border: "1px solid rgba(249,115,22,.28)", color: "#f97316", fontSize: 18, fontWeight: 900 }}>
      {icon}
    </div>
